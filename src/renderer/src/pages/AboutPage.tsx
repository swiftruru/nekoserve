...
function ExternalLink({ href, label }: { href: string; label: string }) {
  return (
    <a
      ...
      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-orange-200 text-orange-600 text-xs font-medium hover:bg-orange-50 transition-colors no-drag"
    >
      ...
      <div className="space-y-4">
        ...
        <div className="card">
          ...
          <div className="grid grid-cols-[5rem_1fr] gap-y-2.5 text-sm">
            <span className="text-gray-400">{t('about:courseBackground.author')}</span>
            <span className="font-medium text-gray-800">{t('about:courseBackground.authorValue')}</span>

            <span className="text-gray-400">{t('about:courseBackground.school')}</span>
            <span className="text-gray-700">{t('about:courseBackground.schoolValue')}</span>

            <span className="text-gray-400">{t('about:courseBackground.department')}</span>
            <span className="text-gray-700">{t('about:courseBackground.departmentValue')}</span>

            <span className="text-gray-400">{t('about:courseBackground.course')}</span>
            <span className="text-gray-700">{t('about:courseBackground.courseValue')}</span>
          </div>

          <div className="border-t border-orange-50 mt-4 pt-4">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 rounded-full bg-orange-50 border border-orange-100 text-sm text-gray-700">
        ...
        <div className="card">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-700 mb-4">
            <div className="space-y-1.5">
              <div className="font-semibold text-orange-600 text-xs mb-1">{t('about:tech.frontendLabel')}</div>
              <p className="text-gray-600">Electron　·　React 18　·　TypeScript</p>
              <p className="text-gray-600">Tailwind CSS　·　Recharts</p>
            </div>
            <div className="space-y-1.5">
              <div className="font-semibold text-orange-600 text-xs mb-1">{t('about:tech.coreLabel')}</div>
              <p className="text-gray-600">Python 3.11　·　SimPy 4</p>
              <p className="text-gray-600">PyInstaller　·　electron-vite</p>
            </div>
          </div>
          ...
          <div className="border-t border-orange-50 pt-4 space-y-3">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-700">{t('about:tech.github')}</p>
                <p className="text-xs text-gray-400">swiftruru/nekoserve</p>
              </div>
              <ExternalLink href="https://github.com/swiftruru/nekoserve" label="GitHub" />
            </div>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-700">{t('about:tech.homepage')}</p>
                <p className="text-xs text-gray-400">swift.moe</p>
              </div>
        ...
        <div className="card">
          ...
          <div className="text-sm text-gray-700 space-y-4 leading-relaxed">
            <div>
              <p className="font-semibold text-orange-700 mb-1">{t('about:experiment.principle1Title')}</p>
              <p>
                <Trans i18nKey="about:experiment.principle1Body" components={boldComponents} />
              </p>
            </div>
            <div>
              <p className="font-semibold text-orange-700 mb-1">{t('about:experiment.principle2Title')}</p>
              <p>{t('about:experiment.principle2Body')}</p>
            </div>
            <div>
              <p className="font-semibold text-orange-700 mb-1">{t('about:experiment.principle3Title')}</p>
              <p className="mb-1">
            ...
            <div>
              <p className="font-semibold text-orange-700 mb-1">{t('about:experiment.principle4Title')}</p>
            ...
            <div>
              <p className="font-semibold text-orange-700 mb-1">{t('about:experiment.principle5Title')}</p>
